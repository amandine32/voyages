...
public class PanelVoyages<Tableau> extends PanelDeBase implements ActionListener, KeyListener
{
	...
	public PanelVoyages()
	{
		...
		String entetes [] = {"date debut voyage","date fin voyage", "lieu voyage"};
		...
		this.uneTable.addMouseListener(new MouseListener(){
			...
			public void mouseClicked(MouseEvent e) {
				...
				}else if(nbClic==1)
				{
					...
					txtDatedeb_voyage.setText( unTableau.getValueAt(numLigne,2).toString());
					txtDatefin_voyage.setText( unTableau.getValueAt(numLigne,3).toString());
					txtLieu_voyage.setText(unTableau.getValueAt(numLigne,4).toString());
	...
	public Object [][] getDonnees(String mot)
	{
		...
		Object[][] matrice = new Object [lesVoyages.size()][10];
		int i=0;
	...
	public void traitement (int choix)
	{
		...
		{
			Voyages unVoyage = new Voyages(0,
					datedebut,
					datefin,
					lieu);
